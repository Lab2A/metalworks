...
| `logo_generate` | Generate five diverse logo options (the model authors each SVG) + a self-contained picker page. Offered, never auto-selected (chat key). | `report_id`, `name`, `store_path` |
